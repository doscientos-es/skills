# Stack operativo: Router frente a Start

La decisión completa, sus fuentes y criterios de adopción están en
[references/stack-decision.md](../skills/operational-react-supabase/references/stack-decision.md),
dentro de la skill distribuible. Editar allí para no mantener recomendaciones divergentes.
